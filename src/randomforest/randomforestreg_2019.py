...
for i, metric in enumerate(aff_metrics):
    ...
    picklesave(f'randomforest/params_{metric}_2019.txt', params)
    ...
    picklesave(f'randomforest/feat_import_{metric}_2019.txt', feat_import)
    ...
    plt.tight_layout()
    plt.savefig(f'randomforest/featimport_{metric}_2019.png', bbox_inches='tight')
    plt.show()
    ...
    plt.gcf().set_size_inches(12, 5)
    plt.tight_layout()
    plt.savefig(f'randomforest/cumfeatimport_{metric}_2019.png', bbox_inches='tight')
    plt.show()
    ...
    plt.legend()
    plt.grid()
    plt.savefig(f'randomforest/scatter_{metric}_2019.png', bbox_inches='tight')
    plt.show()

#%% print 15 most important features for each metric
for i, metric in enumerate(aff_metrics):
...
for i, metric in enumerate(aff_metrics):
    ...
    plt.gcf().set_size_inches(12, 5)
    plt.tight_layout()
    plt.savefig(f'randomforest/subset_featimport_{metric}_2019.png', bbox_inches='tight')
    plt.show()
    ...
    plt.gcf().set_size_inches(12, 5)
    plt.tight_layout()
    plt.savefig(f'randomforest/subset_cumfeatimport_{metric}_2019.png', bbox_inches='tight')
    plt.show()
